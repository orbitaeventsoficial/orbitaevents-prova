...
export const metadata: Metadata = {
  title: "Fiestas temáticas que parecen cine",
  description: "Harry Potter, Halloween, circo o tu propio universo. Montamos escena y la hacemos funcionar.",
};
  ...
  return (
    <section className="section">
      <div className="container">
        <h1 className="h1">Fiestas temáticas que parecen cine</h1>
        <p className="p mt-6">Harry Potter, Halloween, circo o tu propio universo. Montamos escena y la hacemos funcionar.</p>
