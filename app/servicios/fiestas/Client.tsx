...
export default function FiestasClient() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="max-w-3xl mx-auto p-8 bg-gradient-to-br from-oe-gold/20 to-oe-gold/20 rounded-3xl border border-oe-gold/30">
        ...
        <div className="text-center mb-8">
          ...
          <div className="text-oe-gold mt-2">personas</div>
        </div>
        ...
        <div className="space-y-4">
          ...
          />
          <div className="flex justify-between text-sm text-oe-gold">
      ...
      <div className="max-w-5xl mx-auto">
        <motion.div
          initial={{ scale: 0.95 }}
          animate={{ scale: 1 }}
          className="relative p-8 rounded-3xl border-4 border-oe-gold bg-gradient-to-br from-oe-gold/30 to-oe-gold/30 shadow-2xl shadow-oe-gold"
        >
          {/* Badge Flash */}
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-4">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-oe-gold">{PARTY_PACKS[0].tagline}</p>
              ...
              <div className="flex items-baseline gap-4">
                ...
                <div className="text-2xl text-oe-gold line-through">
            ...
            <div className="space-y-6">
              <ul className="space-y-3">
                {PARTY_PACKS[0].features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-oe-gold">{feature}</span>
                  </li>
                ))}
              </ul>
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-oe-gold to-oe-gold-light rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:shadow-2xl hover:shadow-oe-gold/40 transition-all hover:scale-105"
              >
            ...
            return (
              <motion.div
                ...
                className={`
                  ...
                  ${isSelected
                    ? 'border-oe-gold bg-oe-gold/10 shadow-lg shadow-oe-gold/20 scale-105'
                    : isRecommended
              ...
              >
                ...
                <div className="space-y-4 mt-4">
                  <div>
                    ...
                    <p className="text-sm text-oe-gold">{pack.tagline}</p>
                  </div>
                  ...
                  {/* Rango */}
                  <div className="text-sm text-oe-gold">
                  ...
                  <ul className="space-y-2 pt-4 border-t border-white/10">
                    {pack.features.map((feature, idx) => (
                      <li key={idx} className="text-sm text-oe-gold flex items-start gap-2">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      transition-all
                      ${isSelected
                        ? 'bg-oe-gold text-white hover:bg-oe-gold'
      ...
      <div className="mt-16 p-8 bg-white/5 rounded-2xl border border-white/10 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-oe-gold">
          <div>
