...
import { PartyPopper, Sparkles, BadgeCheck, Mic2, Music2 } from "lucide-react";
    ...
    <section className="relative pt-32 pb-20 text-center">
      ...
      >
        <h1 className="text-[40px] md:text-[56px] font-black leading-[1.05] tracking-tight text-white mb-3">
          <ChromeText>DJ para fiestas privadas y temáticas</ChromeText>
        </h1>
        <p className="text-white/80 text-lg">
          Cumpleaños, cenas y fiestas temáticas con criterio musical real. Ambiente cuidado, volumen cómodo y pista encendida.
        </p>
        ...
        <div className="mt-8 flex justify-center gap-3 flex-wrap">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-white/80 backdrop-blur">
            <BadgeCheck className="h-4 w-4" /> Producción completa
          </span>
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-white/80 backdrop-blur">
            <Sparkles className="h-4 w-4" /> Luz y sonido coordinados
          </span>
        </div>
      </motion.div>
    </section>
  ...
  const items = [
    {
      ...
      desc: "Selección musical adaptada al grupo. Nada de listas aleatorias.",
    },
    {
      icon: Sparkles,
      title: "Luz con sentido",
      desc: "Escenas cálidas para conversar y efectos cuando toca bailar.",
    },
    {
      icon: BadgeCheck,
      title: "Sonido limpio",
      desc: "Voz clara para microjuegos y anuncios. Sin acoples.",
    },
  ] as const;
  ...
  const packs = [
    {
      name: "Privada",
      price: "690 €",
      line: "Hasta 4 h · 80 personas",
      points: [
        "Selección musical acordada",
        "Micros y sonido para discursos",
        "Luz básica y elegante",
      ],
    },
    {
      name: "Temática",
      price: "990 €",
      line: "Hasta 5 h · 150 personas",
      points: [
        "Concepto musical y estético",
        "Efectos ligeros en pista",
        "Briefing previo y momentos clave",
      ],
      featured: true,
    },
    {
      name: "Corporativa",
      price: "1.390 €",
      line: "Hasta 6 h · 250 personas",
      points: [
        "Rigor horario y protocolo",
        "Sonido distribuido y microfonía",
        "Técnico dedicado",
      ],
    },
  ] as const;
    ...
    <section className="relative py-20">
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-3xl md:text-5xl font-black text-center text-white mb-12">
          <ChromeText>Packs de fiesta</ChromeText>
        </h2>
...
function CTA() {
  ...
  const waUrl = `https://wa.me/${phone.replace(/\D/g, "")}?text=${encodeURIComponent(
    "Hola Òrbita, quiero información para una fiesta privada."
  )}`;
    ...
    <section className="relative py-20 text-center">
      <div className="mx-auto max-w-2xl px-4">
        <h2 className="text-3xl md:text-5xl font-black text-white mb-3">
          <ChromeText>¿Hacemos la fiesta como toca?</ChromeText>
        </h2>
        <p className="text-white/70 mb-6">
          Fecha, lugar y tipo de fiesta. Te confirmamos disponibilidad y presupuesto cerrado.
        </p>
